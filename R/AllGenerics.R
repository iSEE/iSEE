...
#' \code{.getSpecificHelp(x)} takes a \linkS4class{Panel} \code{x} and should return a character vector containing the names of the documented fields.
#' A documented field is a slot of \code{x} where the corresponding UI element has a clickable icon (usually generated by functions like \code{\link{.selectInput.iSEE}})
#' that launches a self-guided tour of that UI element, typically explaining the behavior and effects of the associated parameter.
#'
...
#' Each tour only needs to be defined once per class and is used for all instances of that class.
#'
#' @author 
#' Aaron Lun
#'
...
#' @export
setGeneric(".getSpecificHelp", function(x) standardGeneric(".getSpecificHelp"))
