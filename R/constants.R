...
.redDimType <- function(i) paste0("redDimType", i)
.redDimXAxis <- function(i) paste0("redDimXAxis", i)
.redDimYAxis <- function(i) paste0("redDimYAxis", i)
...
.geneExprID <- function(i) paste0("geneExprID", i)
.geneExprAssay <- function(i) paste0("geneExprAssay", i)
