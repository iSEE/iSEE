...
#' \itemize{
#' \item \code{\link{.showSelectionDetails}(x)} returns a HTML element generated by calling the function registered in \code{\link{iSEEOptions}$get("ColumnTable.select.details")} on \code{x[["Selected"]]}.
