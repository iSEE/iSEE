...
#'
#' @docType methods
#' @aliases initialize,ColumnTable-method
#' @aliases .refineParameters,ColumnTable-method
#' @aliases .defineInterface,ColumnTable-method
#' @aliases .createObservers,ColumnTable-method
#' @aliases .hideInterface,ColumnTable-method
#' @aliases .multiSelectionDimension,ColumnTable-method
#' @aliases .multiSelectionResponsive,ColumnTable-method
#' @aliases .singleSelectionDimension,ColumnTable-method
#' @aliases .showSelectionDetails,ColumnTable-method
