...
setMethod(".definePanelTour", "DotPlot", function(x) {
    ...
    collated <- rbind(
        ...
        .add_tour_step(x, .visualParamChoice, "For instance, it is possible to label a custom set of data points. <br/><br/><strong>Action:</strong> tick the checkbox labelled \"Text\"."),
        .add_tour_step(x, .plotCustomLabels, "This button enables custom labels. <strong>Action:</strong> tick the checkbox."),
        .add_tour_step(x, .dimnamesModalOpen, "This button launches a modal including a text editor where users can input a custom list of identifiers that indicates the data points to label."),
        callNextMethod(),
