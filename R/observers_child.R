...
#' Once all of the requests are collated, the child propagationg observer will run
...
#' 
#' When requesting a change to a panel \code{x}, the output for that panel is always regenerated by \code{\link{.generateOutput}}.
