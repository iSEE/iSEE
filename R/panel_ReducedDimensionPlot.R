...
setMethod(".definePanelTour", "ReducedDimensionPlot", function(x) {
    ...
    collated <- rbind(
        c(paste0("#", .getEncodedName(x)), "The <font color=\"#402ee8\">Reduced dimension plot</font> panel shows reduced dimensions from a <code>SingleCellExperiment</code> object or one of its subclasses. Here, each point corresponds to a column (usually a cell) of the <code>SingleCellExperiment</code>."),
