...
setMethod(".definePanelTour", "RowDataTable", function(x) {
    rbind(
        c(paste0("#", .getEncodedName(x)), "The <font color=\"#402ee8\">Row data table</font> panel contains a representation of the <code>rowData</code> of our <code>SummarizedExperiment</code> object. Each row here corresponds to a row (i.e., feature) of the <code>SummarizedExperiment</code> while each column of the table is a row metadata variable."),
