...
#' \item{\code{tooltip.rowdata}}{A character vector specifying columns of the \code{\link{rowData}} to show in the tooltip for \linkS4class{ColumnDotPlot} instances. Defaults to `character(0)`, which displays only the `colnames` value.}
#' \item{\code{tooltip.coldata}}{A character vector specifying columns of the \code{\link{colData}} to show in the tooltip for \linkS4class{RowDotPlot} instances. Defaults to `character(0)`, which displays only the `rownames` value.}
#' }
#'
