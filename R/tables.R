...
#' @param id Integer scalar specifying the index of a panel of the specified type, for the receiving plot.
...
#' @param id Integer scalar specifying the index of a panel of the specified type, for the receiving panel. 
#' @param pObjects An environment containing \code{table_links}, a graph produced by \code{.\link{spawn_table_links}};
#' and \code{memory}, a list of DataFrames containing parameters for each panel of each type.
#'
#' @return \code{NULL}, invisibly.
