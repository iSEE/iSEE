...
This requires all panels acting as both receivers and transmitters to have their effects set to `"Restrict"` - see `r Biocpkg("iSEE", vignette="xtreme.html#exploring-mass-cytometry-date", label="here")` for an example with mass cytometry data.
