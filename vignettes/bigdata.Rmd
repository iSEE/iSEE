...
The `ReducedDimensionHexPlot` class from the `r Biocpkg("iSEEu")` package will create a hexplot rather than a scatter plot,
thus avoiding the need to render each point in the reduced dimension plot.
