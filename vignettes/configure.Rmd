...
3. `"Feature name"`: requires either
    ...
    b. `XAxisFeatureSource` to be set to the name of a _Row statistics table_ panel with an active selection set in its own `Selected` column.
...
cdArgs <- ColumnDataPlot(SelectionBoxOpen=TRUE, 
    ColumnSelectionSource="ReducedDimPlot1",
