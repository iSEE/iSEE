...
## Configuring the default point color
...
## Linking the point color to a variable

The color of data points can be linked to variables in a manner similar to the X and Y axes demonstrated in the data parameters section [above](#data).
...
Note how both categorical (e.g. `"Core.Type"`) and continuous (e.g. `"TOTAL_DUP"`) variables can be selected.
