...
We demonstrate below each of the 4 scenarios, as examples 1 to 3:
...
However, we warn users against mixing character and integer values, as this will cause integer values to be converted to the character type.
