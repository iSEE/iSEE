...
In `CUSTOM`, an empty _ggplot_ is returned if there is no selection on the columns, while the default `runPCA` behaviour is used if `feature_set=NULL`.
...
... this would pass `colour_by="Nanog"` and `scale_columns="TRUE"` to `CUSTOM_PCA`.
