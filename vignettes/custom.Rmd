...
app <- iSEE(sce,
    initial=list(
        ColumnDataPlot(XAxis="Column data", XAxisColumnData="Primary.Type", 
            PanelId=1L),
...
app <- iSEE(sce,
    initial=list(
        ...
        GENERATOR(ColumnSelectionSource="RedDimPlot1")
    )
)
```
...
app <- iSEE(sce, initial=list(ReducedDimensionPlot(PanelId=1L),
    TAB_GEN(ColumnSelectionSource="RedDimPlot1"),
    HEAT_GEN(ColumnSelectionSource="RedDimPlot1"))
)
```
