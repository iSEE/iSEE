...
In this case, the _second_ and _third_ arguments of the user-defined functions must each accept a named list of 2 items, `"active"` and `"saved"`, respectively.
This feature is described in further detail and demonstrated in a [later section](#customSendAll).
...
This obviously occurs if there are no active and/or saved selections, or if no transmitter has been selected.
