...
Assuming that we have the `sce` object from the earlier vignette, we create an `iSEE` app with the `SingleCellExperiment` object and the colormap generated above.
