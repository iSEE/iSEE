...
First, open the "Selection parameters" panel under the *Feature expression plot*,and choose `Receive brush from:` to be `Reduced dimension plot 1` and set the `Brush effect` to `Transparent`.
