...
Finally, we set colour palettes to use in `iSEE` when colouring according to specific cell annotations or expression values. These values are stored in an object of the `ExperimentColorMap` class. 
