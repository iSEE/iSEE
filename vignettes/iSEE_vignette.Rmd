...
`r Biocpkg("iSEE")` controls the aspect of color maps via the `ExperimentColorMap` class. 
A default set of different palettes used will reflect the nature of the data being displayed, i.e. continuous and categorical variables will be handled accordingly.

The advantage of using this class is ...

The user can specify a number of different parameters to tweak the behavior of the coloring options. Some examples on how to use it are available in the documentation of the `ExperimentColorMap` itself, as well as in use in Section \@ref(usecase-ecm).
...
### Generating color maps {#usecase-ecm}
