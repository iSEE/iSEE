...
For instance, the mean log[2]-expression of each gene, the count of samples in which each gene was detected, and the proportion of samples in which each gene was detected :
