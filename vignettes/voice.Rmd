...
- "**Create panel <Reduced dimension plot>**": Adds a new panel of the requested type to the GUI and immediately takes vocal control of it.
- "**Remove panel <Reduced dimension plot 1>**": Removes the requested panel from the GUI. If the panel was under vocal control, clears vocal control.
